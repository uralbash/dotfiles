...
# {{{ Mercurial
source ~/.completion/hg.sh
#}}}

# {{{ Bazaar
source ~/.completion/bazaar.sh
#}}}
...
FORTUNE=$(( $RANDOM % 5 ))
if (( FORTUNE == 0 ));
then fortune | cowsay -f $cowperson;
elif (( FORTUNE == 1 ));
then fortune ru | cowsay -f $cowperson;
elif (( FORTUNE == 2 ));
then
    if (( RANDOM % 2 ));
    then
        fortune ~/.bash-org-ru/bashorgru/ | cowsay -f $cowperson;
    else
        fortune ~/.bash-org-ru/ipfwru/ | cowsay -f $cowperson;
    fi
elif (( FORTUNE == 3 ));
then fortune ~/.bash-org-ru/lorquotesru/ | cowsay -f $cowperson;
elif (( FORTUNE == 4 ));
then fortune 50% debian-hints 50% ubuntu-server-tips \
    | cowsay -f $cowperson;
fi
# }}}
